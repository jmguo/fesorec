...
public class EntranceGAHuge {
	...
	public static void main(String[] args) {
		...
		EntranceGAHuge entrance=new EntranceGAHuge();
		...
		try{
			...
			for(int i=0;i<dataSetNum.length;i++){
				...
				//String tmpath="AverageData-bigger-"+dataSetNum[i]+".txt";
				...
				for(int j=100;j<199;j++){
					...
					rateOfMHEU=(double)entrance.resultOfMHEU/entrance.estimateMaxValueGA;
